...
<center>
                <div class="row">
                        ...
                        <br>
                        <p><center><font face="Algerian" size="4">Calendário, Os pontos que aparecem em cores são os eventos especiais</font></center></p>
                        <br>
                        <div class="borde">
                            <br>
...
<div class="borde1"><br>
 <center><font color="red" face="Algerian"><div class="page-header"><h2></h2></div></font></center>
    <center>
                                       <div class="btn-group">
                                            <button class="btn btn-warning" data-calendar-nav="prev"><< Voltar</button>
                                            <button class="btn btn-primary" data-calendar-nav="today">Hoje</button>
                                            <button class="btn btn-warning" data-calendar-nav="next">Seguinte >></button>
                                        </div><br><br>
                                        <div class="btn-group">
                                            <button class="btn btn-info" data-calendar-view="year">Ano</button>
                                            <button class="btn btn-info active" data-calendar-view="month">Mês</button>
