 ...
 *
 * @author gelvazio
 * Faça um algoritmo que leia o horario de entrada e saída de um funcionario.
 * O algoritmo deve fornecer quantas horas e quantos minutos o empregado ficou
 * na empresa.
 * OBS:Funcionario pode ter entrada 18:00 Horas e saido ás 2 da manhã.
 */
public class Algoritmo_Sete {
