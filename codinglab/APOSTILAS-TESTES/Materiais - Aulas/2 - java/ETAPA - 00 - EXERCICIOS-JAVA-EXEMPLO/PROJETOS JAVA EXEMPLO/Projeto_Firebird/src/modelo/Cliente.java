...
public class Cliente {
    ...
    public Cliente(int cli_codigo,int telefone, String nome, String email, String pai, String mae, String bairro, String datanascimento, int end_numero, String endereco, String sexo, int cid_codigo) {
