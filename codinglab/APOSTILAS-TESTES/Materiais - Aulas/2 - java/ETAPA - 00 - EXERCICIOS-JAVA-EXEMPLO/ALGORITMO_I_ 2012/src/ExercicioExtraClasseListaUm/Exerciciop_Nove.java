 ...
 *
 * @author aluno
 * 9) Faça um programa que leia o horário de entrada (hora e minuto) 
 * e o horário de saída (hora e minuto) de um empregado e 
 * imprima quanto tempo, no formato hora:minuto, o empregado ficou na empresa.
 */
public class Exerciciop_Nove {
