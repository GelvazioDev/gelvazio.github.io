...
public class Interface extends JFrame implements ActionListener, ItemListener {
	...
	//metodo que faz o painel do bot�es
	...
	//metodo que desabilita os bot�es caso a solu��o seja pedida pelo usu�rio
	...
	//metodo que trata os eventos dos bot�es das letras
