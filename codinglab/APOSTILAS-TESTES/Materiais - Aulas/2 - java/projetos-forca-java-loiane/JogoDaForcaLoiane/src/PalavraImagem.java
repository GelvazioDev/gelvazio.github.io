...
public class PalavraImagem {
    ...
    //metodo construtor que recebe como parametro o segredo e o nome da figura separadamente
    public PalavraImagem(String s, String f) {
        this.segredo = s;
        this.figura = f;
    }

    //metodo construtor que recebe a linha inteira do arquivo e separa em segredo e figura
    ...
    //metodo construtor que inicializa os atributos com uma string vazia
