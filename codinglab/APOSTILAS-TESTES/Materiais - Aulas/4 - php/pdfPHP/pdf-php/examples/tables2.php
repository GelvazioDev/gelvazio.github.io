...
$coloptions = array('num' => array('justification' => 'right'),
    'name' => array('justification' => 'left'),
    'type' => array('justification' => 'center'));

$pdf->ezText("ola", 12);

$pdf->ezText("using 'showLines' option - DEPRECATED", 12);

$pdf->ezText("Default: showLines = 1", 10);

$pdf->ezTable($data, $cols);

$pdf->ezText("Disabled showLines = 0\n", 10);
...
$pdf->ezTable($data,array('type'=>'Type','name'=>'Alias'),'' ,array('showHeadings'=>1,
    'shaded'=>0,'showLines'=>4));
